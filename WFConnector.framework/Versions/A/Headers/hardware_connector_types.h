...
typedef enum
{
    ...
    // can this enum be reorded safely?  If so, probably could put the two TICKR variants together, for neatness.
    // MUZZ: I added exact values, some apps might store it, then we can re-order for neatness :-)
